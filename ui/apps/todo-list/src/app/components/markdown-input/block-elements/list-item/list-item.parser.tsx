...
export const UNORDERED_LIST_ITEM_ID = 'unordered-list-item';
export const UNORDERED_LIST_ITEM_PARSER: MarkdownElementConfig = {
  id: UNORDERED_LIST_ITEM_ID,
  regex: /^( ?)+[-+*] (?!\[(x| )]).*$/gm,
...
export const ORDERED_LIST_ITEM_ID = 'ordered-list-item';
export const ORDERED_LIST_ITEM_PARSER: MarkdownElementConfig = {
  id: ORDERED_LIST_ITEM_ID,
  regex: /^( ?)+\d+\. .*$/gm,
  parser: (children, indentPx = 0) => (
